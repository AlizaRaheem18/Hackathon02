...
interface Car {
  name: string;
  type: string;
  image: string; // Make sure to use the correct image property
  fuel: string;
  transmission: string;
  seats: number;
  price: number;
...
interface CarCardProps {
  car: Car; // Props type for CarCard
}
...
const CarCard: React.FC<CarCardProps> = ({ car }) => {
  return (
    <div className="bg-white rounded-lg shadow-md p-4 flex flex-col items-center">
      ...
      <div className="mt-2">
        <Image
          src={'/car01.png'} // Use the car.image property
          alt={car.name}
          width={300}
          height={150}
...
const PopularCars = () => {
  const cars = [
    ...
    },
    {
      name: "Rolls-Royce",
      type: "Sedan",
      image: "/rolls-royce.png", // Ensure this is the correct image
      fuel: "70L",
      transmission: "Manual",
      seats: 2,
      price: 80,
    ...
    },
    {
      ...
      type: "Sport",
      image: "/lamborghini-aventador.png", // Ensure this is the correct image
      fuel: "85L",
